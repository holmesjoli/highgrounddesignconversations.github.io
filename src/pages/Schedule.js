...
const schedule = {thursday: [
                    {header: "Thursday 7.9", p: "lodging check-in", time: "afternoon – early eve"},
                    {header: "", p: "happy hour at main HGDC House",  time: "5 – 7pm"}],
                  friday: [
                    {header: "Friday 7.10", p: "light breakfast", time: "8:30am", day: "Friday"},
                  ...
                  saturday: [
                    {header: "Saturday 7.11", p: "light breakfast", time: "8:30am"},
                  ...
                  sunday: [
                    {header: "Sunday 7.12", p: "associate and scholar remarks", time: "9 – 10:30am", day: "Sunday"}
                  ]
};
